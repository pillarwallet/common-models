...
const schema = schemaCreator.createSchema(
  {
    ...
    /**
     * @name iconMonoUrl
     * @desc The token's predefined monochrome icon image.
     * @type String
     * @memberof Asset
     * @inner
     */
    ...
    /**
     * @name patternUrl
     * @desc The token's predefined icon image (bigger).
     * @type String
     * @memberof AssetDev
     * @inner
     */
 ...
 * @namespace AssetDev
 * @name AssetDev
 * @desc AssetDev model maps to a MongoDB collection and defines the shape of the document.
 *
 * @param schema
 * @type {Model}
 */
module.exports = mongoose.model('AssetDev', schema);
